        ...
        return {
            ...
            "commands": [
                ...
                {"type": "prime", "risk": "routine",
                 "preconditions": ["mode:ENDPOINT", "state:idle"],
                 "typical_duration_s": timeline("prime", self.analyte)["total"] / self.speed},
                {"type": "calibrate", "risk": "disruptive",
                 "params": {"std_conc": {"type": "number", "required": True,
                                         ...
                                         "doc": "concentration of the standard; "
                                                "module enforces > 0"}},
                 "preconditions": ["mode:ENDPOINT", "state:idle"],
                 "typical_duration_s": timeline("calibrate", self.analyte)["total"] / self.speed},
                {"type": "sample", "risk": "routine",
                 "preconditions": ["mode:ENDPOINT", "state:idle"],
                 "typical_duration_s": timeline("sample", self.analyte)["total"] / self.speed},
